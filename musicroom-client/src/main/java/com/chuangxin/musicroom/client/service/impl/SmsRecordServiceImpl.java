...
import com.chuangxin.musicroom.client.mapper.SmsRecordMapper;
...
public class SmsRecordServiceImpl extends ServiceImpl<SmsRecordMapper, SmsRecord> implements SmsRecordService {
    ...
    @Override
    public BaseResult getList(Page<SmsRecord> page, Map<String, Object> map) {
        page.setTotal(0);
        IPage<SmsRecord> iPage = smsRecordMapper.getList(page, map); 
